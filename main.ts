...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Player, function (sprite, otherSprite) {
    playerSprite.setPosition(6, 104)
    info.changeLifeBy(-1)
})
...
let carImg = carListRight[randint(0, 2)]
let carImgRight = carListRight[randint(0, 2)]
carImgRight.flipX()
playerSprite.x = 30
playerSprite.y = 130
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
game.splash("Monkey crossing", "Tap A to play ")
game.splash("Objective cross the road", "and get the Bannana ")
let nana = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
...
game.onUpdateInterval(2000, function () {
    for (let index = 0; index < 10; index++) {
        projectile = sprites.create(img`
            ...
            ...........c2fff........
            `, SpriteKind.Projectile)
        projectile.setPosition(80, 7)
        projectile.setVelocity(50, 100)
    }
})
game.onUpdateInterval(1000, function () {
    if (Math.percentChance(40)) {
        projectile = sprites.createProjectileFromSide(carImgRight, -25, 0)
        projectile.setPosition(160, 60)
    }
})
game.onUpdateInterval(3500, function () {
    for (let index = 0; index < 10; index++) {
        projectile = sprites.create(img`
            ...
            ...........c2fff........
            `, SpriteKind.Projectile)
        projectile.setPosition(90, 93)
        projectile.setVelocity(-50, -100)
    }
})
game.onUpdateInterval(500, function () {
    if (Math.percentChance(40)) {
        projectile = sprites.createProjectileFromSide(carImg, 25, 0)
        projectile.setPosition(0, 25)
    }
})
